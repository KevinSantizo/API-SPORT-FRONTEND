  ...
  <v-container class=" overflow-hidden mx-auto">
    ...
    <BottomNavigation/> 
      <v-container class="bottom">
        ...
        <v-carousel cycle height="250" hide-delimiter-background :show-arrows="false" class="my-3">
          <v-carousel-item v-for="(company, i) in this.companies" :key="i" >
            <v-img class="white--text " height="250" :src="company.image" gradient="to bottom, rgba(0.5,0,0,0.5), rgba(0.5,0,0,0.5)" style="border-radius: 10px;">
          ...
          <v-hover>
              ...
              <v-row class="fill-height pa-4 ma-2" align="center" justify="center">  
                <div  class="headline font-weight-bold font">
                  ...
                  <v-row justify="center" >
                  <span class="body-1">{{fields.length}} Canchas</span>
                  </v-row>
                </div>                      
              </v-row>
              </v-card>
        ...
        <v-row justify="center">
          <v-hover>
            <v-card  router to="/companies" class="my-1 link ma-1 "  style="border-radius: 10px; background-color: #004E64" dark width=375 height=200 :elevation=12>
              <v-row class="fill-height pa-4 ma-2" align="center" justify="center">  
                <div  class="headline font-weight-bold font">
                  <span text class="font" >Lugares<v-icon right size="40">mdi-stadium-variant</v-icon></span><br>
                  <v-row justify="center">
                ...
                <v-btn  color="black"  class="link" router to="/reserve"  fab dark  outlined>
                 ...
                 <v-slide-group>
                  <v-slide-item v-for="reservation in this.user_today_reservation.reservations" :key="reservation.id" :reservation="reservation"> 
                    <v-hover >
                      <v-card class="link ma-1  light-green lighten-5" style="border-radius: 5px;"  width=325>
                      ...
                      <v-card-title><span></span>{{ reservation.field_reserve.company.name }}, {{ reservation.field_reserve.company.town.department.name }}</v-card-title>
                        ...
                        <span v-if="reservation.field_reserve.type == 1" class="body-2 font-weight-bold font  white--text">Tipo de cancha: Fútbol 5</span>
                        <span v-else-if="reservation.field_reserve.type == 2" class="body-2 font-weight-bold font  white--text">Fútbol 7</span>
                        <span v-else class="body-2 font-weight-bold font  white--text">Fútbol 11</span><br>
                        </v-card-subtitle>    
